...
import { useAddConvertedGamesMutation } from '@/hooks/useAddConvertedGamesMutation';
...
const Dashboard = () => {
  ...
  const handleTestRawgBackup = () => {
    const converted = [
      {
        id: 662318,
        slug: 'wolverine-2022',
        name: "Marvel's Wolverine",
        name_original: "Marvel's Wolverine",
        description:
          '<p>Marvel’s Wolverine is currently in development by Insomniac Games for PlayStation 5. Created in collaboration with Marvel Games and PlayStation.</p>',
        metacritic: null,
        metacritic_platforms: [],
        released: null,
        tba: true,
        updated: '2021-09-13T09:33:56',
        background_image:
          'https://media.rawg.io/media/screenshots/b2e/b2e232b291a77ec285978aa4ef80ea85.jpg',
        background_image_additional:
          'https://media.rawg.io/media/screenshots/ca0/ca0c8fcca9feaf6d64c5e222018143d0.jpg',
        website: 'https://www.youtube.com/watch?v=5iTjgmp3SnA',
        rating: 0,
        rating_top: 0,
        ratings: [],
        reactions: {},
      ...
      },
      {
        ...
        name_original: 'Clair Obscur: Expedition 33',
        description:
          '<p>Once a year, the Paintress wakes and paints upon her monolith. Paints her cursed number. And everyone of that age turns to smoke and fades away. Year by year, that number ticks down and more of us are erased. Tomorrow she’ll wake and paint “33.” And tomorrow we depart on our final mission - Destroy the Paintress, so she can never paint death again.</p>\n<p>We are Expedition 33.</p>',
        metacritic: null,
        metacritic_platforms: [],
        released: '2025-04-24',
        tba: false,
        updated: '2025-03-24T03:09:44',
        background_image:
          'https://media.rawg.io/media/games/466/4667f17fdee9ebbcea2049e54f8e2b96.jpg',
        background_image_additional:
          'https://media.rawg.io/media/screenshots/97c/97c3638fadb04e0302c07e437ad3085d.jpg',
        ...
        developers: [
          {
            id: 14617,
            name: 'Sundial Interactive',
            slug: 'sundial-interactive',
            games_count: 2,
            image_background:
              'https://media.rawg.io/media/screenshots/804/80484c27bac42558017a59507a82dc8e.jpg',
          },
        ],
        genres: [
          {
        ...
        publishers: [
          {
            ...
            slug: 'kepler-interactive',
            games_count: 10,
            image_background:
              'https://media.rawg.io/media/screenshots/7f2/7f2fc0ecea075a42b1d030d3c67ab37d.jpg',
          },
        ],
        esrb_rating: {
          id: 4,
      ...
      },
      {
        ...
        tags: [
          ...
          },
          {
            ...
            games_count: 499,
            image_background:
              'https://media.rawg.io/media/games/b30/b30d472a13528007721f4a236b04ae7f.jpg',
          },
          {
            id: 295,
            name: 'Soundtrack',
      ...
      },
      {
        ...
        tags: [
          ...
          },
          {
            ...
            games_count: 480,
            image_background:
              'https://media.rawg.io/media/screenshots/bbd/bbd0c68bc8169f0bb9134cc0e01539c2.jpg',
          },
          {
            id: 6580,
            name: 'defender',
      ...
      },
      {
        ...
        tags: [
          ...
          },
          {
            ...
            games_count: 1654,
            image_background:
              'https://media.rawg.io/media/games/3a9/3a9ea2db24f879e61fe7b824f5888d2a.jpg',
          },
          {
            id: 108,
            name: 'Mythology',
      ...
      },
      {
        ...
        tags: [
          ...
          },
          {
            ...
            games_count: 1521,
            image_background:
              'https://media.rawg.io/media/screenshots/886/886cdc03930d853910fb6ed9f8f754fb.jpg',
          },
          {
            id: 49959,
            name: '2D Platformer',
          ...
          },
          {
            ...
            games_count: 1215,
            image_background:
              'https://media.rawg.io/media/games/e69/e69fae35b4e3afe8f6357c01fa6a0e6c.jpg',
          },
        ],
        esrb_rating: {
          id: 3,
    ...
    ].map((game) => convertRAWGGameToAPI(game));

    console.log('converted', converted);

    addRawgBackup(converted);
  };
  ...
  return (
    <div className="grid grid-cols-1 gap-4 p-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
      ...
      <button onClick={handleTestRawgBackup}>Test!</button>
    </div>
  );
};
